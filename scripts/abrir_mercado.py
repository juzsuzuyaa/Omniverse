...
try:
    ...
    if mercado['aberto_fechado'] == 1:
        print("❌ O mercado já está aberto.")
    else:
        # Abrir o mercado
        cursor.execute("UPDATE mercado SET aberto_fechado = 1 WHERE id = 1")
        conexao.commit()
        print("✅ Mercado aberto com sucesso!")
